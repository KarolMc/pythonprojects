...
class Menu:
  def __init__(self, name, items, start_time, end_time):
    #the object's name attribute is equal to the name
    self.name = name
    self.items = items
  ...
  def calculate_bill(self, purchased_items):
    ...
    for purchased_item in purchased_items:
      #check if item is actually on the menu
...
#test out calculate_bill - (chosen menu.function(list of purchased items))
#print(brunch_menu.calculate_bill(['pancakes', 'home fries', 'coffee']))

#building franchise information 
